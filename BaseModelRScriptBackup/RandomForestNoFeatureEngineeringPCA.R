...
###########################################
saveRDS(rf_model, file = "Stat380Final/Base_Models/RandomForestNoFeatureEngineeringPCA.rds")
cat("Model saved as 'Stat380Final/Base_Models/RandomForestNoFeatureEngineeringPCA.rds'. To load it later, use:\n")
cat("loaded_model <- readRDS('Stat380Final/Base_Models/RandomForestNoFeatureEngineeringPCA.rds')\n\n")
...
write.csv(best_tune_df, "Stat380Final/Base_Models_Data/Random_Forest/BestHyperparams_RandomForestNoFeatureEngineeringPCA.csv", row.names = FALSE)
cat("BestTune hyperparameters saved as 'Stat380Final/Base_Models_Data/Random_Forest/BestHyperparams_RandomForestNoFeatureEngineeringPCA.csv'.\n\n")
...
if(length(levels_labels) == 2) {
  ...
  write.csv(cm_df, "Stat380Final/Base_Models_Data/Random_Forest/ConfusionMatrix_RandomForestNoFeatureEngineeringPCA.csv", row.names = FALSE)
  cat("Confusion matrix saved as 'Stat380Final/Base_Models_Data/Random_Forest/ConfusionMatrix_RandomForestNoFeatureEngineeringPCA.csv'.\n\n")
  ...
  write.csv(metrics_df, "Stat380Final/Base_Models_Data/Random_Forest/Metrics_RandomForestNoFeatureEngineeringPCA.csv", row.names = FALSE)
  cat("Performance metrics saved as 'Stat380Final/Base_Models_Data/Random_Forest/Metrics_RandomForestNoFeatureEngineeringPCA.csv'.\n")
  ...
  write.csv(roc_data, "Stat380Final/Base_Models_Data/Random_Forest/ROCData_RandomForestNoFeatureEngineeringPCA.csv", row.names = FALSE)
  cat("ROC data saved as 'Stat380Final/Base_Models_Data/Random_Forest/ROCData_RandomForestNoFeatureEngineeringPCA.csv'.\n")
  ...
  ggsave("Stat380Final/Base_Models_Data/Random_Forest/ROC_RandomForestNoFeatureEngineeringPCA.png", 
         plot = roc_plot, width = 7, height = 7, dpi = 300)
  cat("ROC plot saved as 'Stat380Final/Base_Models_Data/Random_Forest/ROC_RandomForestNoFeatureEngineeringPCA.png'.\n")
