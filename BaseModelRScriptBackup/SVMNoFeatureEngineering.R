...
train <- read_csv("Stat380Final/Prepped_Data/trainNoFeatureEngineering.csv", show_col_types = FALSE)
test <- read_csv("Stat380Final/Prepped_Data/testNoFeatureEngineering.csv", show_col_types = FALSE)
...
###########################################
saveRDS(svm_model, file = "Stat380Final/Base_Models/SVMModelNoFeatureEngineering.rds")
cat("Model saved as 'Stat380Final/Base_Models/SVMModelNoFeatureEngineering.rds'. To load it later, use:\n")
cat("loaded_model <- readRDS('Stat380Final/Base_Models/SVMModelNoFeatureEngineering.rds')\n\n")
...
write.csv(best_tune_df, "Stat380Final/Base_Models_Data/SVM/BestHyperparams_SVMNoFeatureEngineering.csv", row.names = FALSE)
cat("BestTune hyperparameters saved as 'Stat380Final/Base_Models_Data/SVM/BestHyperparams_SVMNoFeatureEngineering.csv'.\n\n")
...
if(length(levels_labels) == 2) {
  ...
  write.csv(cm_df, "Stat380Final/Base_Models_Data/SVM/ConfusionMatrix_SVMNoFeatureEngineering.csv", row.names = FALSE)
  cat("Confusion matrix saved as 'Stat380Final/Base_Models_Data/SVM/ConfusionMatrix_SVMNoFeatureEngineering.csv'.\n\n")
  ...
  write.csv(metrics_df, "Stat380Final/Base_Models_Data/SVM/Metrics_SVMNoFeatureEngineering.csv", row.names = FALSE)
  cat("Performance metrics saved as 'Stat380Final/Base_Models_Data/SVM/Metrics_SVMNoFeatureEngineering.csv'.\n")
  ...
  write.csv(roc_data, "Stat380Final/Base_Models_Data/SVM/ROCData_SVMNoFeatureEngineering.csv", row.names = FALSE)
  cat("ROC Data for plot building saved as 'Stat380Final/Base_Models_Data/SVM/ROCData_SVMNoFeatureEngineering.csv'.\n")
  ...
  ggsave("Stat380Final/Base_Models_Data/SVM/ROC_SVMNoFeatureEngineering.png", 
         plot = roc_plot, width = 7, height = 7, dpi = 300)
  cat("ROC plot saved as 'Stat380Final/Base_Models_Data/SVM/ROC_SVMNoFeatureEngineering.png'.\n")
