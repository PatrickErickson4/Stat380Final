...
###########################################
saveRDS(svm_model, file = "Stat380Final/Base_Models/SVMModelNoFeatureEngineeringPCA.rds")
cat("Model saved as 'Stat380Final/Base_Models/SVMModelNoFeatureEngineeringPCA.rds'. To load it later, use:\n")
cat("loaded_model <- readRDS('Stat380Final/Base_Models/SVMModelNoFeatureEngineeringPCA.rds')\n\n")
...
write.csv(best_tune_df, "Stat380Final/Base_Models_Data/SVM/BestHyperparams_SVMNoFeatureEngineeringPCA.csv", row.names = FALSE)
cat("BestTune hyperparameters saved as 'Stat380Final/Base_Models_Data/SVM/BestHyperparams_SVMNoFeatureEngineeringPCA.csv'.\n\n")
...
if(length(levels_labels) == 2) {
  ...
  write.csv(cm_df, "Stat380Final/Base_Models_Data/SVM/ConfusionMatrix_SVMNoFeatureEngineeringPCA.csv", row.names = FALSE)
  cat("Confusion matrix saved as 'Stat380Final/Base_Models_Data/SVM/ConfusionMatrix_SVMNoFeatureEngineeringPCA.csv'.\n\n")
  ...
  write.csv(metrics_df, "Stat380Final/Base_Models_Data/SVM/Metrics_SVMNoFeatureEngineeringPCA.csv", row.names = FALSE)
  cat("Performance metrics saved as 'Stat380Final/Base_Models_Data/SVM/Metrics_SVMNoFeatureEngineeringPCA.csv'.\n")
  ...
  write.csv(roc_data, "Stat380Final/Base_Models_Data/SVM/ROCData_SVMNoFeatureEngineeringPCA.csv", row.names = FALSE)
  cat("ROC Data for plot building saved as 'Stat380Final/Base_Models_Data/SVM/ROCData_SVMNoFeatureEngineeringPCA.csv'.\n")
  ...
  ggsave("Stat380Final/Base_Models_Data/SVM/ROC_SVMNoFeatureEngineeringPCA.png", 
         plot = roc_plot, width = 7, height = 7, dpi = 300)
  cat("ROC plot saved as 'Stat380Final/Base_Models_Data/SVM/ROC_SVMNoFeatureEngineeringPCA.png'.\n")
